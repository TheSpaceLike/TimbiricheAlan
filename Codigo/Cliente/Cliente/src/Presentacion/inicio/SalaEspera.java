...
public class SalaEspera extends javax.swing.JFrame implements IActualizable {
    ...
    public boolean ejecutarConexion(Jugador jugador, String ip, int port) {
        ...
        if (sck.ConnectServ(this.ip, this.port)) {
            System.out.println("Conectado con exito");
            sck.SendServ(this.jugador);
            sck.ListenServ();
            return true;
        } else {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(178, 178, 178)
                .addComponent(botonPrincipal, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void botonPrincipalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonPrincipalActionPerformed
        if (sck.SendServ(MsjSockets.VOTO)) {
